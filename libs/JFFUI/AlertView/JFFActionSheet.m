...
+(void)activeActionSheetsAddSheet:( UIActionSheet* )action_sheet_;
...
+(void)activeActionSheetsAddSheet:( UIActionSheet* )action_sheet_
{
   ...
   [ active_action_sheets_ addObject: action_sheet_ ];
}
...
+(void)activeActionSheetsRemoveSheet:( UIActionSheet* )action_sheet_
{
   ...
   [ active_action_sheets_ removeObject: action_sheet_ ];
...
{
   [ [ self class ] activeActionSheetsAddSheet: self ];
